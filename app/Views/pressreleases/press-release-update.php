...
<section class="card lh-card">
    <div class="card-body p-4 p-lg-5">
        <form method="post" 
              action="/press-release-update"
              enctype="multipart/form-data"
              class="row g-4">

            <div class="col-xl-6 col-lg-6 col-sm-12">
                <input type="hidden" name="_token" value="<?= e($_SESSION['csrf']) ?>">
                <input type="hidden" name="id" value="<?= e($pressRelease['id']) ?>">
                <div class="col-12 mb-3">
                    <label class="form-label" for="title">Title</label>
                    <input class="form-control" id="title" name="title" maxlength="150" value="<?php echo empty(e($pressRelease['title'])) ? "" : e($pressRelease['title']) ?>" required>
                </div>

                <div class="col-12 mb-3">
                    <label class="form-label" for="description">Event Date</label>
                    <input class="form-control" type="date" name="event_date" value="<?php echo empty(e($pressRelease['event_date'])) ? "" : e($pressRelease['event_date']) ?>" required="">
                </div>
                <div class="col-12 mb-3">
                    <label class="form-label" for="file">Cover Photo</label>
                    <input class="form-control" id="cover_photo" name="cover_photo" type="file" accept=".jpg,.jpeg,.png" required>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-12">
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="5" maxlength="5000" value="<?php echo empty(e($pressRelease['description'])) ? "" : e($pressRelease['description']) ?>"></textarea>
                </div>
            </div>
