    ...
    <div class="card-body p-4 p-lg-5">
        <form method="post" action="/promotion-kit-upload" enctype="multipart/form-data" class="row g-4">
            ...
            <div class="col-12">
                ...
                <input class="form-control" id="file" name="file" type="file" accept=".zip,.pdf,.docx,.pptx" required>
                <div class="form-text">ZIP, PDF, DOCX, or PPTX. Maximum file size: 50 MB.</div>
            </div>
