...
4. Ensure the web-service user can write `storage/logs` and `storage/sessions`, `chmod -R +w storage/` then serve the `public` folder: `php -S localhost:8000 -t public`.
